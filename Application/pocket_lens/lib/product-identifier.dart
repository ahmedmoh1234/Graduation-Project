...
class ProductIdentifier extends StatefulWidget {
  const ProductIdentifier({super.key});

  @override
  State<ProductIdentifier> createState() => _ProductIdentifierState();
}

class _ProductIdentifierState extends State<ProductIdentifier> {
